    ...
    <div className="flex flex-1 flex-col bg-background">
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 gap-12 px-6 sm:px-10">
        ...
        <section id="overview" className="max-w-4xl pt-16 pb-8 sm:pt-24">
          ...
          <div className="relative mt-10 aspect-[16/10] w-full max-w-md overflow-hidden rounded-2xl bg-neutral-100">
            {learvoHero.isPlaceholder ? (
              ...
              <Image
                ...
                width={learvoHero.imageWidth}
                height={learvoHero.imageHeight}
                priority
        ...
        <section id="what-i-shipped" className="max-w-4xl py-16">
          ...
          <div className="mt-10 space-y-16">
            {featuresSection.categories.map((cat) => (
              <div key={cat.slug} className="border-t border-black/[0.06] pt-12 first:border-t-0 first:pt-0">
